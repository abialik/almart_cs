...
@section('title', 'Kontak Kami — Almart')

@section('content')
<div class="bg-gray-50 min-h-screen py-20">
    <div class="max-w-4xl mx-auto px-6 bg-white rounded-3xl shadow-sm border border-gray-100 p-10 sm:p-16 text-center">
        <h1 class="text-4xl font-black text-gray-900 mb-4 tracking-tighter">Kontak Kami</h1>
        <p class="text-gray-500 mb-12">Kami siap membantu Anda kapan saja.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div class="p-6 bg-gray-50 rounded-2xl">
                 ...
                 <p class="text-sm text-gray-500">JL Pertanian Grogol limo depok</p>
            </div>
            <div class="p-6 bg-gray-50 rounded-2xl">
                 ...
                 <p class="text-sm text-gray-500">almartofficial@gmail.com</p>
            </div>
            <div class="p-6 bg-gray-50 rounded-2xl">
                 ...
                 <p class="text-sm text-gray-500">0895347920306</p>
            </div>
        </div>
    </div>
</div>
